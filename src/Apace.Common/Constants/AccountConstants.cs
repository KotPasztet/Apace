...
namespace Apace.Common.Constants;
...
public static partial class AccountConstants
{
    ...
    public const int UsernameLengthMax = 16; // keep in sync with Apace.ApiServer.Controllers.Live.LoginController.GenerateUserId()
    ...
    // keep in sync with Apace.ApiServer.Controllers.Live.LoginController.Register()
