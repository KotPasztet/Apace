...
using Apace.ApiServer.Types.Catalog;
using Apace.ApiServer.Utils;
using Apace.StaticData;
using CICIBIEType = Apace.StaticData.Catalog.ItemsCatalogR.Item.BoostInfoR.Effect.TypeE;
using CICIBIType = Apace.StaticData.Catalog.ItemsCatalogR.Item.BoostInfoR.TypeE;
using CICICategory = Apace.StaticData.Catalog.ItemsCatalogR.Item.CategoryE;
using CICIJEBehavior = Apace.StaticData.Catalog.ItemsCatalogR.Item.JournalEntryR.BehaviorE;
using CICIJEBiome = Apace.StaticData.Catalog.ItemsCatalogR.Item.JournalEntryR.BiomeE;
using CICIType = Apace.StaticData.Catalog.ItemsCatalogR.Item.TypeE;
using CICIUseType = Apace.StaticData.Catalog.ItemsCatalogR.Item.UseTypeE;
using CIJGCJGParentCollection = Apace.StaticData.Catalog.ItemJournalGroupsCatalogR.JournalGroup.ParentCollectionE;
using CRCCRCategory = Apace.StaticData.Catalog.RecipesCatalogR.CraftingRecipe.CategoryE;
using ItemsCatalog = Apace.ApiServer.Types.Catalog.ItemsCatalog;
...
internal sealed class CatalogController : ApaceControllerBase
{
