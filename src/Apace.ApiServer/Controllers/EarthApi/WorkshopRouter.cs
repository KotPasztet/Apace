...
using Apace.ApiServer.Exceptions;
using Apace.ApiServer.Utils;
using Apace.Common.Excceptions;
using Apace.Common.Utils;
using Apace.DB.Models.Player;
using Apace.StaticData;
using BurnRate = Apace.ApiServer.Types.Common.BurnRate;
using CraftingCalculator = Apace.ApiServer.Utils.CraftingCalculator;
using CraftingSlot = Apace.DB.Models.Player.Workshop.CraftingSlot;
using CraftingSlots = Apace.DB.Models.Player.Workshop.CraftingSlots;
using EarthApiResponse = Apace.ApiServer.Utils.EarthApiResponse;
using EarthDB = Apace.DB.EarthDB;
using ExpectedPurchasePriceR = Apace.ApiServer.Types.Common.ExpectedPurchasePriceR;
using FinishPrice = Apace.ApiServer.Types.Workshop.FinishPrice;
using Hotbar = Apace.DB.Models.Player.Hotbar;
using InputItem = Apace.DB.Models.Player.Workshop.InputItem;
using Inventory = Apace.DB.Models.Player.Inventory;
using Journal = Apace.DB.Models.Player.Journal;
using NonStackableItemInstance = Apace.DB.Models.Common.NonStackableItemInstance;
using OutputItem = Apace.ApiServer.Types.Workshop.OutputItem;
using Profile = Apace.DB.Models.Player.Profile;
using Rewards = Apace.ApiServer.Utils.Rewards;
using SmeltingCalculator = Apace.ApiServer.Utils.SmeltingCalculator;
using SmeltingSlot = Apace.DB.Models.Player.Workshop.SmeltingSlot;
using SmeltingSlots = Apace.DB.Models.Player.Workshop.SmeltingSlots;
using SplitRubies = Apace.ApiServer.Types.Profile.SplitRubies;
using State = Apace.ApiServer.Types.Workshop.State;
using TimeFormatter = Apace.ApiServer.Utils.TimeFormatter;
using UnlockPrice = Apace.ApiServer.Types.Workshop.UnlockPrice;
...
internal sealed class WorkshopRouter : ApaceControllerBase
{
