...
using ApiRewards = Apace.ApiServer.Types.Common.Rewards;
using RedeemRewards = Apace.ApiServer.Utils.Rewards;
...
internal sealed class ChallengeActionsController : ApaceControllerBase
{
