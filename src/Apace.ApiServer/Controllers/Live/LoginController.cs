...
using static Apace.Common.Constants.AccountConstants;

namespace Apace.ApiServer.Controllers.Live;

[Route("")]
[Route("login.live.com")]
internal sealed partial class LoginController : ApaceControllerBase
{
