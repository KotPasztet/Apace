...
using Apace.DB;
using ActivityLog = Apace.DB.Models.Player.ActivityLog;
using ChallengeProgressVersion = Apace.ApiServer.Utils.ChallengeProgressVersion;
...
internal sealed partial class ClientController : ApaceControllerBase
{
    ...
    private static int CountRewardItems(Apace.DB.Models.Common.Rewards rewards)
